...
import com.essycynthia.calibanfoodmobile.domain.repository.FreeLunchRepository import com.essycynthia.calibanfoodmobile.util.Resource
...
class ReceivedRewardHistoryViewModel @Inject constructor(
    ...
    private fun getAllLunches(){ viewModelScope.launch {
        when (val response = freeLunchRepository.getAllLunches("Bearer")){ is Resource.Success -> receivedRewardUiState =
