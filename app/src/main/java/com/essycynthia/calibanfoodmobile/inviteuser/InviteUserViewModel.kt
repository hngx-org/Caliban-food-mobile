...
class InviteUserViewModel @Inject constructor(
    ...
    fun createOrganisationInvite(email:String){
        viewModelScope.launch {
            ...
            try {
                ...
                inviteUserState.value = InviteUserState(isLoading = false, errorMessage = "An error occurred while creating a user invite")
            }
        }
    }
}
